...
\author{
  Enguerand Chr\'{e}tien\textsuperscript{1} \quad
  Th\'{e}ophile Jouanno\textsuperscript{1} \quad
  Jean-Philippe Winckler\textsuperscript{1}\\[4pt]
  \textsuperscript{1}VitroBOT, Paris, France\\
  \texttt{\{enguerand, theophile, jph.winckler\}@vitrobot.site}
}
