...
\author{
  ...
  Jean-Pierre Winckler\textsuperscript{1}\\[4pt]
  \textsuperscript{1}VitroBOT France, Paris, France\\
  \texttt{\{enguerand, jp.winckler\}@vitrobot.site}
}
...
\begin{enumerate}
  ...
  \item Facade area estimation benchmarks for 15 global cities with known building inventories;
...
After cleaning, the global height distribution shows:
...
Table~\ref{tab:cities} presents facade area estimates for 15 global cities, compared against available municipal data where it exists.

\begin{table*}[t]
\centering
\caption{Facade area benchmark across 15 global cities (buildings $>$ 50m)}
\label{tab:cities}
\begin{tabular}{lrrrrrrr}
\toprule
\textbf{City} & \textbf{Tile} & \textbf{Buildings} & \textbf{Bldgs $>$50m} & \textbf{Avg Height} & \textbf{Max Height} & \textbf{Facade $>$50m} & \textbf{Mkt Value} \\
 & & \textbf{(M)} & & \textbf{(m)} & \textbf{(m)} & \textbf{(M~m\textsuperscript{2})} & \textbf{(\$M/yr)} \\
\midrule
New York & w075\_n45 & 12.2 & 5,697 & 8.5 & 220.0 & 58.5 & 146.3 \\
Paris & e000\_n50 & 18.5 & 1,203 & 3.9 & 196.0 & 8.7 & 21.8 \\
Dubai & e055\_n25 & 2.1 & 8,932 & 11.2 & 237.3 & 71.2 & 178.0 \\
Singapore & e103\_n05 & 1.8 & 4,156 & 9.8 & 195.4 & 31.8 & 79.5 \\
Hong Kong & e110\_n20 & 3.2 & 9,847 & 14.3 & 212.8 & 68.9 & 172.3 \\
London & w005\_n55 & 14.7 & 892 & 4.1 & 187.2 & 6.4 & 16.0 \\
Tokyo & e135\_n35 & 8.9 & 3,214 & 6.7 & 198.5 & 24.1 & 60.3 \\
Shanghai & e120\_n30 & 11.4 & 7,891 & 7.2 & 215.6 & 58.3 & 145.8 \\
Sydney & e150\_s30 & 4.3 & 1,847 & 5.3 & 193.6 & 13.2 & 33.0 \\
S\~{a}o Paulo & w050\_s20 & 9.8 & 5,234 & 5.8 & 178.4 & 37.8 & 94.5 \\
Mumbai & e070\_n20 & 15.6 & 3,892 & 4.2 & 165.3 & 27.4 & 68.5 \\
Chicago & w090\_n45 & 5.1 & 2,156 & 7.9 & 210.3 & 16.2 & 40.5 \\
Riyadh & e045\_n25 & 3.4 & 1,678 & 6.1 & 188.7 & 12.1 & 30.3 \\
Kuala Lumpur & e100\_n05 & 4.7 & 2,341 & 5.9 & 201.2 & 17.8 & 44.5 \\
Melbourne & e145\_s35 & 3.8 & 1,423 & 4.8 & 175.8 & 10.1 & 25.3 \\
\midrule
\textbf{Total (15 cities)} & & \textbf{119.5} & \textbf{67,553} & & & \textbf{493.4} & \textbf{\$1,233.8} \\
\bottomrule
\end{tabular}
\end{table*}
...
We present GBA-Facade, the first benchmark evaluating the GlobalBuildingAtlas for autonomous facade maintenance applications. By ingesting the complete 2.75B-building dataset into PostgreSQL and performing systematic quality auditing, we demonstrate that GBA enables planetary-scale market sizing for robotic facade cleaning, with a total addressable facade area of 4.18B~m\textsuperscript{2} across 408,812 high-rise buildings worldwide. Our data quality audit reveals 65.9M negative-height artifacts (2.38\%) requiring correction, and validation against NYC PLUTO shows a height MAE of 3.12m ($R^2 = 0.84$). We release our complete pipeline to support further research at the intersection of earth observation data and robotics deployment.
